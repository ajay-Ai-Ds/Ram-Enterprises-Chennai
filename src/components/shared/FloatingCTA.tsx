  ...
  return (
    <div className="fixed bottom-5 right-5 z-50 flex flex-col gap-3 md:bottom-8 md:right-8 items-end">
      ...
      <AnimatePresence>
        {showScrollTop && (
          <motion.button
            ...
            className="flex items-center justify-center w-12 h-12 bg-[#0F2137] text-white rounded-full shadow-xl hover:bg-[#B87333] hover:text-white transition-colors duration-300 relative group cursor-pointer focus:outline-hidden"
          >
            <ArrowUp className="w-5 h-5 text-white group-hover:text-white transition-colors" />
            <span className="absolute right-14 bg-[#0F2137] text-white text-xs font-semibold px-3 py-1.5 rounded-md shadow-md opacity-0 pointer-events-none group-hover:opacity-100 transition-opacity duration-300 whitespace-nowrap">
              Scroll to Top
            </span>
          </motion.button>
        )}
      ...
      <motion.a
        ...
        className="flex items-center justify-center w-13 h-13 bg-[#B87333] hover:bg-[#D08A52] text-white rounded-full shadow-[0_15px_40px_rgba(184, 115, 51,0.35)] hover:shadow-[0_20px_45px_rgba(184, 115, 51,0.50)] transition-all duration-300 relative group cursor-pointer"
      >
        <Phone className="w-6 h-6 text-[#06101C]" />
        <span className="absolute right-16 bg-[#0F2137] text-white text-xs font-semibold px-3 py-1.5 rounded-md shadow-lg opacity-0 pointer-events-none group-hover:opacity-100 transition-opacity duration-300 whitespace-nowrap">
          Call +91 90305 05683
        </span>
        <span className="absolute inset-0 w-full h-full rounded-full bg-[#B87333] animate-ping opacity-30 -z-10 group-hover:hidden"></span>
      </motion.a>
      ...
      <motion.a
        ...
        whileHover={{ scale: 1.1 }}
        whileTap={{ scale: 0.95 }}
        aria-label="Chat on WhatsApp with Ram Enterprises"
