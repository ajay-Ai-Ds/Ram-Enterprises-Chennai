    ...
    <div className="flex flex-col gap-3 py-6 border-t border-b border-slate-200">
      ...
      <div className="flex flex-wrap gap-2.5">
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center gap-1.5 bg-emerald-50 hover:bg-emerald-100 text-blue-700 px-3.5 py-2 rounded-xl text-xs font-bold transition-colors"
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center gap-1.5 bg-emerald-50 hover:bg-emerald-100 text-[#0F2137] px-3.5 py-2 rounded-xl text-xs font-bold transition-colors"
