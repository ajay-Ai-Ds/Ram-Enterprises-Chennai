    ...
    <div className="bg-white/95 backdrop-blur-md rounded-3xl p-6 sm:p-8 shadow-2xl border border-white/40 text-slate-800">
      ...
      {status === "success" ? (
        <div className="py-8 text-center space-y-4">
          ...
          <div className="pt-2">
            <a
              href={`https://wa.me/919030505683?text=Hi%20Ram%20Enterprises,%20I%20just%20submitted%20a%20request%20for%20${encodeURIComponent(
                serviceName
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              } rounded-xl text-slate-900 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-[#B87333] focus:bg-white transition-all`}
            />
          ...
          {status === "error" && (
            <p className="text-xs text-rose-600 bg-rose-50 p-2.5 rounded-lg border border-rose-100">
              There was an issue sending your inquiry. Please call us directly at <strong>+91 90305 05683</strong>.
            </p>
          )}
          ...
          <button
            ...
            className="w-full py-3 px-4 bg-gradient-to-r from-[#B87333] to-[#01579B] hover:from-[#039BE5] hover:to-[#B87333] text-white font-bold text-sm rounded-xl shadow-lg shadow-sky-900/20 flex items-center justify-center gap-2 transition-all transform active:scale-[0.98] cursor-pointer disabled:opacity-75"
          >
            {status === "loading" ? (
              <>
