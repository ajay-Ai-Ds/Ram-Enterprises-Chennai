  ...
  return (
    <section className="relative bg-slate-900 text-white overflow-hidden py-20 lg:py-32">
      ...
      <div className="absolute inset-0 z-0">
        <Image
          src={image}
          alt={`Ram Enterprises - ${name} Installation in Chennai`}
          fill
          priority
          sizes="100vw"
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col gap-5 items-start">
            <span className="bg-[#B87333] text-white text-xs font-bold uppercase tracking-wider px-3.5 py-1.5 rounded-full">
              {categoryName}
            </span>
            ...
            >
              <div className="flex items-center gap-2 text-xs font-bold text-[#B87333] tracking-wider uppercase">
                <span className="w-2 h-2 rounded-full bg-[#B87333] animate-pulse"></span>
                <span>Ram Enterprises AI OVERVIEW</span>
              </div>
            ...
            <div className="flex flex-wrap gap-4 mt-4 w-full sm:w-auto">
              <a
                ...
                className="w-full sm:w-auto flex items-center justify-center gap-2.5 bg-[#B87333] text-white font-bold px-6 py-4 rounded-full hover:bg-accent-hover transition-colors shadow-lg hover:shadow-xl text-sm"
              >
        ...
        >
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-3 w-full md:w-auto">
              <a
                href="tel:+91 90305 05683"
                className="flex-1 md:flex-none flex items-center justify-center gap-2 bg-[#B87333] text-white font-bold px-5 py-3 rounded-full hover:bg-accent-hover text-xs sm:text-sm shadow-xs transition-colors"
              >
              ...
              <Link
                href="#contact"
                className="flex-1 md:flex-none flex items-center justify-center gap-2 bg-[#0F2137] hover:bg-[#B87333] text-white font-bold px-5 py-3 rounded-full text-xs sm:text-sm shadow-xs transition-colors"
              >
...
export function ServiceTrustBar() {
  const trustBadges = [
    { label: "Professional Installation", icon: <Wrench className="w-4 h-4 text-[#B87333]" /> },
    { label: "Premium Materials", icon: <ShieldCheck className="w-4 h-4 text-[#B87333]" /> },
    { label: "Fast Response", icon: <Clock className="w-4 h-4 text-[#B87333]" /> },
    { label: "Affordable Pricing", icon: <Award className="w-4 h-4 text-[#B87333]" /> },
    { label: "Chennai, Tamil Nadu Coverage", icon: <Globe className="w-4 h-4 text-[#B87333]" /> },
    { label: "Customer Satisfaction", icon: <CheckCircle2 className="w-4 h-4 text-[#B87333]" /> },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
          {trustBadges.map((badge, idx) => (
            ...
            >
              <div className="p-1.5 bg-[#FDF6F0] rounded-lg shrink-0">
                {badge.icon}
              </div>
