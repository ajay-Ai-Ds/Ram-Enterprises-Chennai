      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 sm:px-8 flex flex-col md:flex-row items-center gap-10">
        ...
        <div className="flex-1 text-center md:text-left flex flex-col gap-3">
          ...
          <p className="text-slate-400 text-xs sm:text-sm leading-relaxed max-w-md">
            Get monthly guides on childproofing apartments, balcony bird exclusions, and maintaining stainless steel invisible grills from Ram Enterprises.
          </p>
        </div>
        ...
        <div className="w-full md:w-80 bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl p-5 shrink-0">
          {status === "success" ? (
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4.5" noValidate>
              {status === "error" && (
                <div className="p-3 bg-[#FDF6F0]0/10 border border-red-500/20 text-red-400 text-[11px] rounded-lg flex items-center gap-2" role="alert">
              ...
              <div className="flex flex-col gap-1 text-left">
                ...
                <input
                  ...
                  {...register("name")}
                  className="w-full bg-slate-800/40 border border-white/10 px-3.5 py-2.5 rounded-lg text-xs focus:outline-hidden focus:ring-1 focus:ring-[#B87333] text-white"
                />
                {errors.name && (
              ...
              <button
                ...
                className="w-full bg-[#B87333] hover:bg-accent-hover text-white text-xs font-bold py-3 rounded-lg shadow-md cursor-pointer transition-colors flex items-center justify-center gap-1.5 focus:outline-hidden focus:ring-1 focus:ring-[#B87333]"
              >
