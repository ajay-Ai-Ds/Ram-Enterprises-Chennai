...
export async function fetchSiteSettings() {
  ...
  if (isMock) {
    return {
      ...
      phone: "+91 90305 05683",
      secondaryPhone: "+91 90309 05683",
      email: "ramenterpriseschennai@gmail.com",
      showNewsletter: true,
      socialLinks: {
        facebook: "https://facebook.com/ramenterpriseschennai",
        instagram: "https://instagram.com/ramenterpriseschennai",
        linkedin: "https://linkedin.com/company/ramenterpriseschennai",
        youtube: "https://youtube.com/ramenterpriseschennai",
      },
    };
  }
