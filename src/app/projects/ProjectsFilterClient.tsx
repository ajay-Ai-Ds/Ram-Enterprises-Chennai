          ...
          {filteredProjects.slice(0, visibleCount).map((project) => (
            ...
            >
              ...
              <div className="relative h-48 w-full bg-slate-200 overflow-hidden">
                <Image
                  src={project.image}
                  alt={`Ram Enterprises - ${project.name} in ${project.location}`}
                  fill
              ...
              <div className="p-6 flex flex-col flex-grow">
                ...
                <h3 className="text-base font-bold text-slate-800 mb-2 group-hover:text-[#B87333] transition-colors">
                  {project.name}
                </h3>
      ...
      {filteredProjects.length > visibleCount && (
        <div className="flex justify-center mt-6">
          <button
            ...
            className="bg-[#0F2137] hover:bg-[#B87333] text-white text-xs sm:text-sm font-bold px-8 py-3.5 rounded-full cursor-pointer transition-colors shadow-sm"
          >
            Load More Projects
          </button>
        </div>
