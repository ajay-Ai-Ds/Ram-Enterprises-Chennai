...
export const metadata: Metadata = {
  title: "Request Received | Ram Enterprises - Safety Nets & Invisible Grills Chennai, Tamil Nadu",
  description:
    "Your request for a free site measurement and quote has been successfully received by Ram Enterprises. We will contact you shortly.",
  robots: {
    index: false,
    follow: true,
  },
    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-6 text-center select-none">
      <div className="max-w-md bg-white rounded-3xl p-8 sm:p-12 border border-slate-200 shadow-md flex flex-col items-center gap-6">
        ...
        <p className="text-slate-500 text-xs sm:text-sm leading-relaxed">
          Thank you for contacting Ram Enterprises. Our local Chennai, Tamil Nadu team will review your service requirements and contact you within 24 hours to schedule your free site inspection.
        </p>
        ...
        <Link
          href="/"
          className="w-full flex items-center justify-center gap-2 bg-[#0F2137] hover:bg-[#B87333] text-white font-bold py-3.5 rounded-xl transition-all shadow-xs text-xs"
        >
