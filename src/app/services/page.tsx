...
export const metadata: Metadata = {
  title: "Our Services | Ram Enterprises - Safety Nets & Invisible Grills Chennai, Tamil Nadu",
  description:
    "Explore 18+ safety net solutions, invisible grills, and ceiling cloth hangers by Ram Enterprises across Chennai: Adyar, Velachery, Anna Nagar, T. Nagar, Tambaram, Porur, and OMR Sholinganallur.",
  alternates: {
    canonical: "/services",
  },
  openGraph: {
    ...
    description:
      "Explore 18+ safety net solutions, invisible grills, and ceiling cloth hangers by Ram Enterprises across Chennai: Adyar, Velachery, Anna Nagar, T. Nagar, Tambaram, Porur, and OMR Sholinganallur.",
    url: "https://ramenterpriseschennai.com/services",
    images: [
      {
        url: "/images/og-image.webp",
        width: 1200,
        height: 630,
        alt: "Ram Enterprises Services",
      },
    ],
  },
  twitter: {
    ...
    title: "Our Services | Ram Enterprises - Safety Nets & Invisible Grills Chennai, Tamil Nadu",
    description:
      "Explore 18+ safety net solutions, invisible grills, and ceiling cloth hangers by Ram Enterprises across Chennai serving Adyar, Velachery, Anna Nagar, T. Nagar, Tambaram, Porur, and OMR.",
  ...
  const categories = [
    {
      ...
      icon: <Shield className="w-5 h-5 text-[#B87333]" />,
    ...
    },
    {
      ...
      icon: <Eye className="w-5 h-5 text-[#B87333]" />,
    ...
    },
    {
      ...
      icon: <Settings className="w-5 h-5 text-[#B87333]" />,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-left max-w-3xl mb-16 flex flex-col gap-3">
          ...
          <p className="text-slate-500 text-sm sm:text-base leading-relaxed">
            Choose from our 18 certified safety netting, structural invisible grills, and drying hanger services in Chennai. Handcrafted to protect your space cleanly.
          </p>
        </div>
