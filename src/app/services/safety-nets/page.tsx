...
export const metadata: Metadata = {
  title: "Balcony & Safety Nets | Ram Enterprises - Safety Nets & Invisible Grills Chennai, Tamil Nadu",
  description:
    "High-tensile UV-treated balcony safety nets, pigeon nets, child protection nets, and pet safety nets installed by Ram Enterprises across Chennai: Adyar, Velachery, Anna Nagar, T. Nagar, Tambaram, Porur, and OMR Sholinganallur.",
  alternates: {
  ...
  openGraph: {
    ...
    description:
      "High-tensile UV-treated balcony safety nets, pigeon nets, child protection nets, and pet safety nets installed by Ram Enterprises across Chennai: Adyar, Velachery, Anna Nagar, T. Nagar, Tambaram, Porur, and OMR Sholinganallur.",
    url: "https://ramenterpriseschennai.com/services/safety-nets",
    images: [
      {
        url: "/images/og-image.webp",
        width: 1200,
        height: 630,
        alt: "Safety Nets Chennai, Tamil Nadu - Ram Enterprises",
      },
    ],
  },
  twitter: {
    ...
    title: "Balcony & Safety Nets | Ram Enterprises - Safety Nets & Invisible Grills Chennai, Tamil Nadu",
    description:
      "High-tensile safety nets installed across Chennai serving Adyar, Velachery, Anna Nagar, T. Nagar, Tambaram, Porur, and OMR.",
  ...
  const breadcrumbSchema = {
    ...
    "itemListElement": [
      ...
      },
      {
        ...
        "position": 3,
        "name": "Safety Nets",
        "item": "https://www.ramenterpriseschennai.com/services/safety-nets",
      },
    ],
  };
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-left max-w-3xl mb-16 flex flex-col gap-3">
          ...
          <p className="text-slate-500 text-sm sm:text-base leading-relaxed">
            Protect your family, pets, and structures with high-density copolymer netting. Designed for Chennai, Tamil Nadu&apos;s weather and custom anchored to meet absolute safety benchmarks.
          </p>
        </div>
