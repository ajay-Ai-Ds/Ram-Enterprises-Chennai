...
export const metadata: Metadata = {
  title: "Ceiling Cloth Hangers | Ram Enterprises - Safety Nets & Invisible Grills Chennai, Tamil Nadu",
  description:
    "Rust-proof ceiling-mounted pulley cloth drying hangers installed in balconies and utility spaces by Ram Enterprises across Chennai: Adyar, Velachery, Anna Nagar, T. Nagar, Tambaram, Porur, and OMR Sholinganallur.",
  alternates: {
  ...
  openGraph: {
    ...
    description:
      "Rust-proof ceiling-mounted pulley cloth drying hangers installed in balconies and utility spaces by Ram Enterprises across Chennai: Adyar, Velachery, Anna Nagar, T. Nagar, Tambaram, Porur, and OMR Sholinganallur.",
    url: "https://ramenterpriseschennai.com/services/cloth-hangers",
    images: [
      {
        url: "/images/og-image.webp",
        width: 1200,
        height: 630,
        alt: "Ceiling Cloth Hangers Chennai, Tamil Nadu - Ram Enterprises",
      },
    ],
  },
  twitter: {
    ...
    title: "Ceiling Cloth Hangers | Ram Enterprises - Safety Nets & Invisible Grills Chennai, Tamil Nadu",
    description:
      "Space-saving ceiling cloth hangers installed across Chennai serving Adyar, Velachery, Anna Nagar, T. Nagar, Tambaram, Porur, and OMR.",
  ...
  const breadcrumbSchema = {
    ...
    "itemListElement": [
      ...
      },
      {
        ...
        "position": 3,
        "name": "Cloth Hangers",
        "item": "https://www.ramenterpriseschennai.com/services/cloth-hangers",
      },
    ],
  };
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-left max-w-3xl mb-16 flex flex-col gap-3">
          ...
          <p className="text-slate-500 text-sm sm:text-base leading-relaxed">
            Optimize your balcony floor space using our space-saving cloth hangers. Choose from ceiling-mounted pulley hangers (smooth raising/lowering cords) or wall-mounted folding accordion grids. Heavy-duty, rustproof stainless steel pipes engineered for humid Chennai, Tamil Nadu weather.
          </p>
        </div>
