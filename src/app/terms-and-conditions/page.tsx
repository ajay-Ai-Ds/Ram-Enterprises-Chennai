...
export const metadata: Metadata = {
  title: "Terms & Conditions | Ram Enterprises - Safety Nets & Invisible Grills Chennai, Tamil Nadu",
  description:
    "Official Terms and Conditions for Ram Enterprises. Review our transparent service pricing, 3-to-5 year warranty certificate guidelines, humane bird control standards, and free measurement terms across Chennai.",
  alternates: {
    canonical: "/terms-and-conditions",
  },
  openGraph: {
    title: "Terms & Conditions | Ram Enterprises",
    description:
      "Review terms of service, transparent pricing, warranty commitments, and safety installation policies for Ram Enterprises across Chennai.",
    url: "https://ramenterpriseschennai.com/terms-and-conditions",
    images: [
      {
        url: "/images/og-image.webp",
        width: 1200,
        height: 630,
        alt: "Ram Enterprises Terms & Conditions",
      },
    ],
  },
};
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white rounded-3xl p-6 sm:p-12 border border-slate-200/80 shadow-xs">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 p-5 bg-emerald-50/40 border border-emerald-100 rounded-2xl mb-10">
            ...
            <div className="flex items-start gap-3">
              <HeartHandshake className="w-5 h-5 text-[#0F2137] shrink-0 mt-0.5" />
              <div>
          ...
          <div className="space-y-8 text-slate-700 text-sm leading-relaxed">
            <section>
              ...
              <p>
                Welcome to Ram Enterprises. By visiting our website, submitting an inquiry form, or booking our safety netting, invisible grills, or bird deterrent installation services across Chennai, you agree to be bound by these Terms and Conditions. These terms ensure a transparent, secure, and professional relationship between Ram Enterprises (&ldquo;Company&rdquo;, &ldquo;we&rdquo;, or &ldquo;our&rdquo;) and the customer (&ldquo;you&rdquo;).
              </p>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc pl-5 space-y-1.5 text-slate-600">
                <li><strong>No-Obligation Inspections:</strong> We provide 100% complimentary site visits and laser measurements across Adyar, Velachery, Anna Nagar, T. Nagar, Tambaram, Madipakkam, Porur, and surrounding Chennai, Tamil Nadu areas.</li>
            ...
            <section>
              ...
              <p className="mb-2">
                Ram Enterprises strictly adheres to ethical, non-cruel, and humane pest deterrence standards:
              </p>
            ...
            <section>
              ...
              <p className="text-xs text-slate-600">
                These terms and any service contracts executed by Ram Enterprises shall be governed by and construed in accordance with the laws of India. Any disputes arising in connection with our services shall be subject to the exclusive jurisdiction of the competent courts of Chennai, Tamil Nadu.
              </p>
            </section>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-xs">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <a href="tel:+919030505683" className="font-bold text-white hover:text-emerald-300">
                      +91 90305 05683
                    </a>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <a href="mailto:ramenterpriseschennai@gmail.com" className="font-bold text-white hover:text-emerald-300">
