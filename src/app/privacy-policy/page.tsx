...
export const metadata: Metadata = {
  title: "Privacy Policy | Ram Enterprises - Safety Nets & Invisible Grills Chennai, Tamil Nadu",
  description:
    "Review Ram Enterprises' official Privacy Policy. We respect customer data privacy, adhere to zero-data-sharing principles, and ensure transparent quote & inspection booking across Chennai.",
  alternates: {
    canonical: "/privacy-policy",
  },
  openGraph: {
    title: "Privacy Policy | Ram Enterprises",
    description:
      "Official privacy policy regarding customer inquiries, free site visits, and data protection for Ram Enterprises across Chennai.",
    url: "https://ramenterpriseschennai.com/privacy-policy",
    images: [
      {
        url: "/images/og-image.webp",
        width: 1200,
        height: 630,
        alt: "Ram Enterprises Privacy Policy",
      },
    ],
  },
};
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white rounded-3xl p-6 sm:p-12 border border-slate-200/80 shadow-xs">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-100 pb-6 mb-8">
            <div>
              <div className="inline-flex items-center gap-2 px-3 py-1 bg-[#FDF6F0] text-[#B87333] text-xs font-bold rounded-full mb-3">
            ...
            <div className="text-right sm:border-l sm:border-slate-100 sm:pl-6 hidden sm:block">
              ...
              <span className="text-sm font-bold text-slate-800">Ram Enterprises</span>
            </div>
          </div>

          {/* Key Privacy Highlights Card */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 p-5 bg-[#FDF6F0]/50 border border-[#F2D2BD] rounded-2xl mb-10">
            <div className="flex items-start gap-3">
              <Lock className="w-5 h-5 text-[#B87333] shrink-0 mt-0.5" />
              <div>
          ...
          <div className="space-y-8 text-slate-700 text-sm leading-relaxed">
            <section>
              <h2 className="text-lg font-bold text-slate-900 mb-3 flex items-center gap-2">
                <span className="w-6 h-6 rounded-md bg-emerald-50 text-[#B87333] flex items-center justify-center text-xs font-bold">1</span>
                Introduction &amp; Scope
              </h2>
              <p>
                Ram Enterprises (&ldquo;we&rdquo;, &ldquo;our&rdquo;, or &ldquo;us&rdquo;) is committed to protecting the privacy and personal data of homeowners, property managers, and commercial clients visiting our website (<strong>https://ramenterpriseschennai.com</strong>) and utilizing our professional safety netting, invisible grills, and bird control services across Chennai.
              </p>
            </section>

            <section>
              <h2 className="text-lg font-bold text-slate-900 mb-3 flex items-center gap-2">
                <span className="w-6 h-6 rounded-md bg-emerald-50 text-[#B87333] flex items-center justify-center text-xs font-bold">2</span>
              ...
              <ul className="list-disc pl-5 space-y-1.5 text-slate-600">
                ...
                <li><strong>Location &amp; Address:</strong> City, neighborhood/locality (e.g., Adyar, Velachery, Anna Nagar, T. Nagar, Tambaram, Madipakkam, Porur), and apartment complex name for dispatching technicians.</li>
            ...
            <section>
              <h2 className="text-lg font-bold text-slate-900 mb-3 flex items-center gap-2">
                <span className="w-6 h-6 rounded-md bg-emerald-50 text-[#B87333] flex items-center justify-center text-xs font-bold">3</span>
            ...
            <section>
              <h2 className="text-lg font-bold text-slate-900 mb-3 flex items-center gap-2">
                <span className="w-6 h-6 rounded-md bg-emerald-50 text-[#B87333] flex items-center justify-center text-xs font-bold">4</span>
                Zero Third-Party Data Sharing &amp; Anti-Spam Policy
              </h2>
              <p>
                <strong>We have a strict Zero Third-Party Data Monetization policy.</strong> We do not sell, rent, license, or transfer your personal contact details to external marketing agencies, lead brokers, or unrelated third parties. Your information remains strictly within Ram Enterprises and authorized service technicians dispatched to your location.
              </p>
            </section>

            <section>
              <h2 className="text-lg font-bold text-slate-900 mb-3 flex items-center gap-2">
                <span className="w-6 h-6 rounded-md bg-emerald-50 text-[#B87333] flex items-center justify-center text-xs font-bold">5</span>
            ...
            <section>
              <h2 className="text-lg font-bold text-slate-900 mb-3 flex items-center gap-2">
                <span className="w-6 h-6 rounded-md bg-emerald-50 text-[#B87333] flex items-center justify-center text-xs font-bold">6</span>
            ...
            <section>
              <h2 className="text-lg font-bold text-slate-900 mb-3 flex items-center gap-2">
                <span className="w-6 h-6 rounded-md bg-emerald-50 text-[#B87333] flex items-center justify-center text-xs font-bold">7</span>
            ...
            <section className="bg-slate-900 text-white rounded-2xl p-6 sm:p-8 mt-10">
              <h3 className="text-base sm:text-lg font-bold mb-2 flex items-center gap-2 text-[#B87333]">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-xs">
                <div className="flex items-center gap-3">
                  <div className="w-9 h-9 rounded-xl bg-white/10 text-[#B87333] flex items-center justify-center shrink-0">
                    <Phone className="w-4 h-4" />
                  </div>
                  <div>
                    <span className="text-slate-400 block">Helpline</span>
                    <a href="tel:+919030505683" className="font-bold text-white hover:text-amber-300">
                      +91 90305 05683
                    </a>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <a href="mailto:ramenterpriseschennai@gmail.com" className="font-bold text-white hover:text-amber-300">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <span className="font-bold text-white">All Major Cities, Chennai, Tamil Nadu</span>
                  </div>
                </div>
              </div>
            </section>
