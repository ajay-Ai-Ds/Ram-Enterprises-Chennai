...
export const metadata: Metadata = {
  title: "Safety & Childproofing Blog | Ram Enterprises - Safety Nets & Invisible Grills Chennai, Tamil Nadu",
  description:
    "Expert guides on safety nets, invisible grills, and bird exclusion across Chennai: Adyar, Velachery, Anna Nagar, T. Nagar, Tambaram, Porur, and OMR Sholinganallur.",
  alternates: {
    canonical: "/blog",
  },
  openGraph: {
    ...
    description:
      "Expert guides on safety nets, invisible grills, and bird exclusion across Chennai: Adyar, Velachery, Anna Nagar, T. Nagar, Tambaram, Porur, and OMR Sholinganallur.",
    url: "https://ramenterpriseschennai.com/blog",
    images: [
      {
        url: "/images/og-image.webp",
        width: 1200,
        height: 630,
        alt: "Ram Enterprises Blog",
      },
    ],
  },
  twitter: {
    ...
    title: "Safety & Childproofing Blog | Ram Enterprises - Safety Nets & Invisible Grills Chennai, Tamil Nadu",
    description:
      "Expert guides on safety nets, invisible grills, and bird exclusion across Chennai serving Adyar, Velachery, Anna Nagar, T. Nagar, Tambaram, Porur, and OMR.",
...
export default async function BlogPage() {
  ...
  const collectionSchema = {
    ...
    "@type": "CollectionPage",
    "name": "Safety and Home Childproofing Blog | Ram Enterprises",
    "url": "https://ramenterpriseschennai.com/blog",
    "description": "Resources on balcony netting, invisible grills, and safety advice across Chennai.",
  };
