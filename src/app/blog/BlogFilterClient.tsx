      ...
      <div className="flex flex-col md:flex-row gap-4 items-center justify-between bg-white p-5 rounded-3xl border border-slate-200 shadow-xs">
        ...
        <div className="relative w-full md:w-80">
          ...
          <input
            ...
            className="w-full bg-slate-50 border border-slate-200 focus:border-[#B87333] px-10 py-3 rounded-xl text-sm focus:outline-hidden focus:ring-2 focus:ring-[#B87333]/10 transition-all"
          />
        </div>
      ...
      {filteredPosts.length === 0 ? (
        <div className="text-center py-20 bg-white rounded-3xl border border-slate-200 flex flex-col items-center gap-3">
          ...
          <button
            ...
            className="text-xs font-bold text-[#B87333] hover:text-accent-hover"
          >
            Clear Search
          </button>
        </div>
            ...
            >
              ...
              <div className="p-6 flex flex-col flex-grow text-left">
                <div className="flex items-center gap-3.5 text-[10px] sm:text-xs text-slate-500 font-bold uppercase mb-3">
                  <span className="bg-[#FDF6F0] text-[#B87333] px-2.5 py-1 rounded-sm border border-orange-100">
                    {post.categoryLabel}
                  </span>
                ...
                <h3 className="text-base font-bold text-slate-800 mb-2 group-hover:text-[#B87333] transition-colors line-clamp-2">
                  {post.title}
                </h3>
                ...
                <Link
                  href={`/blog/${post.slug}`}
                  className="flex items-center justify-between text-xs font-bold uppercase tracking-wider text-[#0F2137] hover:text-[#B87333] transition-colors group/btn pt-4 border-t border-slate-50 mt-4"
                >
