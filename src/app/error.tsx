  ...
  return (
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-6 text-center select-none">
      <div className="max-w-md bg-white rounded-3xl p-8 sm:p-12 border border-slate-200 shadow-md flex flex-col items-center gap-6">
        <div className="p-4 bg-[#FDF6F0] text-[#B87333] rounded-full shadow-xs border border-orange-100/50">
        ...
        <div className="flex flex-col gap-3 w-full">
          <button
            onClick={() => reset()}
            className="w-full flex items-center justify-center gap-2 bg-[#B87333] hover:bg-accent-hover text-white font-bold py-3.5 rounded-xl transition-all shadow-xs text-xs cursor-pointer focus:outline-hidden"
          >
          ...
          <a
            href="/"
            className="text-xs text-slate-500 hover:text-[#B87333] font-semibold transition-colors"
          >
            Go Back Home
          </a>
        </div>
