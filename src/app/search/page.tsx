...
export const metadata: Metadata = {
  title: "Search | Ram Enterprises - Safety Nets & Invisible Grills Chennai, Tamil Nadu",
  description:
    "Search across Ram Enterprises balcony safety nets, invisible grills, anti-bird netting, and service locations in Chennai: Adyar, Velachery, Anna Nagar, T. Nagar, Tambaram, Porur, and OMR Sholinganallur.",
  alternates: {
    canonical: "/search",
  },
  openGraph: {
    title: "Search | Ram Enterprises - Safety Nets & Invisible Grills Chennai, Tamil Nadu",
    description:
      "Search across Ram Enterprises balcony safety nets, invisible grills, anti-bird netting, and service locations in Chennai.",
    url: "https://ramenterpriseschennai.com/search",
    images: [
      {
        url: "/images/og-image.webp",
        width: 1200,
        height: 630,
        alt: "Search Ram Enterprises",
      },
    ],
  },
  twitter: {
    ...
    title: "Search | Ram Enterprises - Safety Nets & Invisible Grills Chennai, Tamil Nadu",
    description:
      "Search across Ram Enterprises balcony safety nets, invisible grills, and safety solutions in Chennai.",
    ...
    <div className="bg-slate-50 min-h-screen py-12">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-left mb-10 flex flex-col gap-2">
          <span className="text-xs font-bold uppercase tracking-widest text-[#B87333] bg-[#FDF6F0] px-3 py-1 rounded-full inline-block self-start">
            Fuzzy Finder
          </span>
